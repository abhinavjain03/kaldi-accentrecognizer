...
if [ $stage -le 3 ]; then
  ...
  $cmd $dir/log/create_valid_subset.log \
    ...
    ali-to-post ark:- ark:- \| \
    nnet3-get-egs-multiple-outputs --num-pdfs=$num_pdfs --num-accents=${num_accents} --frame-subsampling-factor=$frame_subsampling_factor \
      $ivector_opts $egs_opts "$valid_feats" \
      ark,s,cs:- ${accent_classfile_path} "ark:$dir/valid_all.egs" || touch $dir/.error &
  $cmd $dir/log/create_train_subset.log \
    ...
    nnet3-get-egs-multiple-outputs --num-pdfs=$num_pdfs --num-accents=${num_accents} --frame-subsampling-factor=$frame_subsampling_factor \
      ...
      ark,s,cs:- ${accent_classfile_path} "ark:$dir/train_subset_all.egs" || touch $dir/.error &
  wait;
...
if [ $stage -le 4 ]; then
  ...
  $cmd JOB=1:$nj $dir/log/get_egs.JOB.log \
    ...
    "ark,s,cs:filter_scp.pl $sdata/JOB/utt2spk $dir/ali.scp | ali-to-pdf $alidir/final.mdl scp:- ark:- | ali-to-post ark:- ark:- |"  ${accent_classfile_path} ark:- \| \
