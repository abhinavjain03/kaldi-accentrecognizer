...
for f in $data/feats.scp $alidir/ali.1.gz $alidir/final.mdl $extra_files; do
...
sort $dir/ali.scp > $dir/ali.scp1
mv $dir/ali.scp $dir/ali.scp_unsorted
mv $dir/ali.scp1 $dir/ali.scp
