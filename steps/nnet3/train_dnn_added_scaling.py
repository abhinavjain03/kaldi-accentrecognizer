...
def get_args():
    ...
    parser.add_argument("--scale", type=str,
                                 ...
                                 choices=["true", "false"],
                                 help="Whether to scale posteriors or not.", default=False)
    parser.add_argument("--scale-factor", type=float, dest='scale_factor',
                        default=-1.0,
                        help="The scale factor when --scale is true.")
    parser.add_argument("--scale-file", type=str, dest='scale_file',
                        default='',
                        help="The file containing the utterances whose posterior needs to be scaled")
...
def train(args, run_opts):
    ...
    if (args.stage <= -4) and args.egs_dir is None:
        ...
        train_lib.acoustic_model_added_scaling.generate_egs(
