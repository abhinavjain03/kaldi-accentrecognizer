...
def get_args():
    ...
    parser.add_argument("--feat-dir", type=str, required=False,
                        ...
                        "the neural network.")
    parser.add_argument("--accents-file", type=str, dest='accents_file',
                        default='', required=False, 
                        help="The file containing all the utterances with their accents")
    parser.add_argument("--num-accents", type=int, dest='num_accents',
                        default=-1, required=False, 
                        help="Number of accents in the data")
...
def train(args, run_opts):
    ...
    if (args.stage <= -4) and args.egs_dir is None:
        ...
        train_lib.acoustic_model_added_multitask.generate_egs(
            data=args.feat_dir, alidir=args.ali_dir, egs_dir=default_egs_dir,
            left_context=left_context, right_context=right_context,
            num_accents=args.num_accents, accents_file=args.accents_file,
            run_opts=run_opts,
