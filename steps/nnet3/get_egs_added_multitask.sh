...
if [ $stage -le 3 ]; then
  ...
  $cmd $dir/log/create_valid_subset.log \
    ...
    ali-to-post ark:- ark:- \| \
    /home/abhinav/kaldi/accents/nnet3-get-egs-mod --num-pdfs=$num_pdfs --num-accents=${num_accents} --accents-file=${accents_file} --frame-subsampling-factor=$frame_subsampling_factor \
